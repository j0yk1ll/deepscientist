...
- Searches a custom knowledge base with semantic search and reranking
...
```python
from deepscientist.agents import create_orchestrator_agent
...
- `OPENAI_API_KEY`
- optionally `DEEPSCIENTIST_WORKSPACE` for the filesystem root.
